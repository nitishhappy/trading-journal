...
export function buildLinkPreviewIfApplicable(url, container, onFail) {
  if (isGoogleDriveUrl(url)) {
    ...
    buildLiveImagePreview([
      ...
      `https://lh3.googleusercontent.com/d/${parsed.id}=s1000`,
      `https://drive.google.com/uc?export=view&id=${parsed.id}`,
      `https://drive.google.com/thumbnail?id=${parsed.id}&sz=w2000`
